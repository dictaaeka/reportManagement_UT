        ...
        <div class="data-management-header">
            <div class="reports-header-content flex items-center justify-between gap-6 p-5 sm:p-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="data-management-header-title">{{ __('Tambah Issue') }}</h2>
                        <p class="data-management-header-description">Buat issue baru untuk mengelompokkan laporan.</p>
                    </div>
                </div>
            ...
            <div class="data-management-card">
                <div class="data-management-card-header">
                    <div class="data-management-card-header-inner">
                        ...
                        <div>
                            <h3 class="data-management-card-title">Form Issue</h3>
                            <p class="data-management-card-description">Isi detail issue yang akan digunakan nanti.</p>
                        </div>
                    </div>
                </div>

                <div class="data-management-card-body">
                    <form action="{{ route('issues.store') }}" method="POST" class="data-management-form-grid">
                        @csrf
                        ...
                        <div class="data-management-field">
                            ...
                            <textarea id="description" name="description" rows="5" class="data-management-textarea">{{ old('description') }}</textarea>
                            @error('description')
                            <p class="data-management-error">{{ $message }}</p>
                            @enderror
                        </div>

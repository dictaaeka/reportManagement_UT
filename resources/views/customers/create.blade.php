        ...
        <div class="data-management-header">
            <div class="reports-header-content flex items-center justify-between gap-6 p-5 sm:p-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="data-management-header-title">{{ __('Tambah Customer') }}</h2>
                        <p class="data-management-header-description">
                            Buat customer baru untuk digunakan pada laporan.
                        </p>
                    </div>
                </div>
            ...
            <div class="data-management-card">
                ...
                <div class="data-management-card-header">
                    <div class="data-management-card-header-inner">
                        ...
                        <div>
                            <h3 class="data-management-card-title">Form Customer</h3>
                            <p class="data-management-card-description">
                                Masukkan nama customer yang akan digunakan dalam laporan.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="data-management-card-body">
                    <form action="{{ route('customers.store') }}" method="POST" class="data-management-form-grid">
                        @csrf
